<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" EnableEventValidation="false" Inherits="Manager.Login" %>
                        ...
                        <div class="w-md-400px">
                            ...
                            <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="../../demo18/dist/index.html" action="#">
                                ...
                                <div class="text-gray-500 text-center fw-semibold fs-6">
                                    Not a Member yet?
								<a href="../../demo18/dist/authentication/layouts/overlay/sign-up.html" class="link-primary">Sign up</a>
                                </div>
                                <!--end::Sign up-->
                            </form>
                            <!--end::Form-->
