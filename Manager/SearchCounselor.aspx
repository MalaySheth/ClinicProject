<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="SearchCounselor.aspx.cs" Inherits="Manager.SearchCounselor" %>
<<<<<<< HEAD
...
<div class="container">
    <asp:Button ID="btnAddCounsellor" runat="server" OnClick="btnAddCounsellor_Click" class="btn btn-bg-smorange btn-color-white float-end mx-2" style="border-radius: 14px" Text="Add New Counsellor" />
</div>
                            ...
                            <div class="card mb-10">
                                ...
                                <div class="card-header border-0 py-5 ">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bold fs-1 mb-1">All Counsellors</span>
                                    </h3>
...
=======
            ...
            <div class="container">
                <a href="AddCounselor.aspx" class="btn btn-bg-smorange btn-color-white float-end mx-2" style="border-radius: 14px">Add New Counselor</a>
            </div>
                ...
                <div class="content flex-row-fluid" id="kt_content">
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="card mb-10">
                            ...
                            <div class="card-header border-0 py-5 ">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold fs-1 mb-1">All Counselors</span>
                                </h3>
