<%@ Page Title="Search Appointment" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="SearchAppointment.aspx.cs" Inherits="Doctor.SearchAppointment" %>
                ...
                <div class="content flex-row-fluid" id="kt_content">
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="card mb-10">
                            ...
                            <!--begin::Body-->
                            <center>
                            <asp:GridView ID="gvPatientAppointment" runat="server" Width="90%" AutoGenerateColumns="False" CellPadding="4" EnableModelValidation="True" ForeColor="#333333" DataKeyNames="PatientAppointmentsId" CssClass="table nowrap paginate_button page-item active" BorderStyle="None"  AllowPaging="True" PageSize="10" OnPageIndexChanging="gvPatientAppointment_PageIndexChanging" OnSelectedIndexChanged="gvPatientAppointment_SelectedIndexChanged" EmptyDataText="No Appointments Found!">
                                            <Columns>
