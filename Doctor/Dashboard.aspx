<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="Doctor.Dashboard" %>
...
<div class="toolbar d-flex flex-stack mb-0 mb-lg-n4 pt-5" id="kt_toolbar">
	...
	<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
		...
		<div class="page-title d-flex flex-column me-3">
			<!--begin::Title-->
			<h1 class="d-flex text-dark fw-bold my-1 fs-3">Doctor Dashboard</h1>
			<!--end::Title-->
			<!--begin::Breadcrumb-->
