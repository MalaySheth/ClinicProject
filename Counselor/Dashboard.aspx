<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="Counselor.Dashboard" %>
					...
					<div class="toolbar d-flex flex-stack mb-0 mb-lg-n4 pt-5" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							...
							<div class="page-title d-flex flex-column me-3">
								<!--begin::Title-->
								<h1 class="d-flex text-dark fw-bold my-1 fs-3">Counselor Dashboard</h1>
								<!--end::Title-->
								<!--begin::Breadcrumb-->
									...
									<div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-70" style="background-color: #F1416C;background-image:url('/assets/media/svg/shapes/wave-bg-red.svg')">
										...
										<div class="card-body d-flex align-items-end mb-3">
											...
											<div class="d-flex align-items-center">
												<asp:Label id="LblTotalAssignedPatients" class="fs-4hx text-white fw-bold me-6" runat="server"/>
												<div class="fw-bold fs-6 text-white">
													<span class="d-block">Total</span>
													<span class="">Assigned Patients</span>
												</div>
											</div>
											<!--end::Info-->
										</div>
								...
								<div class="col-md-6">
									...
									<div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100" style="background-color: #7239EA;background-image:url('/assets/media/svg/shapes/wave-bg-purple.svg')">
										...
										<div class="card-body d-flex align-items-end mb-3">
											<!--begin::Info-->
											<div class="d-flex align-items-center">
												<asp:Label id="LblTotalPendingTasks" class="fs-4hx text-white fw-bold me-6" runat="server"/>
												<div class="fw-bold fs-6 text-white">
													<span class="d-block">Total</span>
