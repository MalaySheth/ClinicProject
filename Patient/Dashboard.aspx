<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="Patient.Dashboard" %>
...
<div class="toolbar d-flex flex-stack mb-0 mb-lg-n4 pt-5" id="kt_toolbar">
	...
	<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
		...
		<div class="page-title d-flex flex-column me-3">
			<!--begin::Title-->
			<h1 class="d-flex text-dark fw-bold my-1 fs-3">Patients Dashboard</h1>
			<!--end::Title-->
			<!--begin::Breadcrumb-->
									...
									<div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100" style="background-color: #7239EA;background-image:url('/assets/media/svg/shapes/wave-bg-purple.svg')">
										...
										<div class="card-header pt-5 mb-3">
											...
											<div class="d-flex flex-center rounded-circle h-80px w-80px" style="border: 1px dashed rgba(255, 255, 255, 0.4);background-color: #7239EA">
												<i class="fa fa-truck-medical text-white fs-2qx lh-0"></i>
											</div>
											<!--end::Icon-->
										</div>
										<!--end::Header-->
										...
										<div class="card-body d-flex align-items-end mb-3">
											<!--begin::Info-->
											<div class="d-flex align-items-center">
												<asp:Label id="LblTotalVisits" class="fs-4hx text-white fw-bold me-6" runat="server"/>
												<div class="fw-bold fs-6 text-white">
													<span class="d-block">Total</span>
													<span class="">Doctor Visits</span>
												</div>
											</div>
											<!--end::Info-->
										</div>
